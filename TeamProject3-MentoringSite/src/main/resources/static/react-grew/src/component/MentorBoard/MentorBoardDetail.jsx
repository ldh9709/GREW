...
import {
  getMentorBoardDetail,
  increaseViewCount,
  deleteMentorBoard,
} from "../../api/mentorBoardApi"; // API 함수 import
...
const MentorBoardDetail = () => {
  ...
  const handleViewCount = async () => {
    const lastViewedTime = localStorage.getItem(
      `mentorBoard-${mentorBoardNo}-lastViewed`
    );
    const now = Date.now();
  ...
  return (
    <div className="mentor-board-detail-container">
      ...
      <div className="mentor-board-detail-header">
        ...
        <h1 className="mentor-board-title">
          {board.mentorBoardTitle || "제목 없음"}
        </h1>
      </div>
      ...
      <div className="mentor-board-author">
        ...
        <div className="author-info">
          ...
          <span className="author-meta">
            ...
            {calculateRelativeDate(board?.mentorBoardDate)}
          </span>
        </div>
      </div>
      ...
      >
        ...
        <div className="mentor-info">
          ...
          <div className="mentor-headline">{mentor.mentorHeadline}</div>
        </div>
