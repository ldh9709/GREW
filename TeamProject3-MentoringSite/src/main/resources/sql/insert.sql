...
INSERT INTO mentor_profile(mentor_profile_no, mentor_introduce, mentor_rating, mentor_mentoring_count, mentor_image, mentor_activity_count, mentor_follow_count, mentor_status, category_no, member_no, mentor_headline)
VALUES(mentor_profile_no_SEQ.nextval, '안녕하세요, 김도옌 멘토입니다.', 5.0, 40, '/images/mentor-profile/11.jpg', 170, 90, 3, 18, member_no_SEQ.currval, '힘이 되어드릴께요');
INSERT INTO career(CAREER_NO, CAREER_COMPANY_NAME, CAREER_JOB_TITLE, CAREER_START_DATE, CAREER_END_DATE, MENTOR_PROFILE_NO)
...
INSERT INTO mentor_profile(mentor_profile_no, mentor_introduce, mentor_rating, mentor_mentoring_count, mentor_image, mentor_activity_count, mentor_follow_count, mentor_status, category_no, member_no, mentor_headline)
VALUES(mentor_profile_no_SEQ.nextval, '안녕하세요, 김도예 멘토입니다.', 5.0, 40, '/images/mentor-profile/12.jpg', 170, 90, 3, 18, member_no_SEQ.currval, '상담이 필요하면 연락주세요');
INSERT INTO career(CAREER_NO, CAREER_COMPANY_NAME, CAREER_JOB_TITLE, CAREER_START_DATE, CAREER_END_DATE, MENTOR_PROFILE_NO)
...
INSERT INTO mentor_profile(mentor_profile_no, mentor_introduce, mentor_rating, mentor_mentoring_count, mentor_image, mentor_activity_count, mentor_follow_count, mentor_status, category_no, member_no, mentor_headline)
VALUES(mentor_profile_no_SEQ.nextval, '안녕하세요, 박정민 멘토입니다. 법률 및 상담 전문가입니다.', 4.9, 42, '/images/mentor-profile/3a.jpg', 160, 70, 3, 18, member_no_SEQ.currval, '법률 상담 전문가');
INSERT INTO career(career_no, career_company_name, career_job_title, career_start_date, career_end_date, mentor_profile_no)
...
INSERT INTO mentor_board (mentor_board_no, mentor_board_title, mentor_board_content, mentor_board_image, mentor_board_date, mentor_board_views, mentor_board_status, member_no) 
VALUES (
    mentor_board_no_SEQ.nextval, 
    '백엔드 개발자가 알아야 할 서버 구조 기초', 
    '백엔드 개발자는 단순히 기능 구현만을 넘어, 효율적인 서버 구조를 설계하고 관리할 수 있는 역량이 필요합니다. 이번 글에서는 백엔드 개발자가 꼭 알아야 할 서버 아키텍처의 기초 개념과 확장성 있는 구조를 만드는 방법을 단계적으로 설명합니다.' || CHR(10) || CHR(10) ||
    '### 1. 서버 아키텍처의 기본 구성 요소' || CHR(10) ||
    '효율적인 백엔드 시스템을 설계하려면 서버의 주요 구성 요소를 이해해야 합니다. 일반적으로 서버 아키텍처는 다음과 같은 계층으로 구성됩니다:' || CHR(10) ||
    '- **프레젠테이션 계층 (Presentation Layer)**: 사용자가 직접 상호작용하는 UI 및 API 계층입니다.' || CHR(10) ||
    '- **애플리케이션 계층 (Application Layer)**: 비즈니스 로직을 처리하고, 데이터 계층과 상호작용하는 역할을 합니다.' || CHR(10) ||
    '- **데이터 계층 (Data Layer)**: 데이터베이스와 저장소를 포함하며, 데이터를 저장하고 관리하는 기능을 수행합니다.' || CHR(10) || CHR(10) ||
    '이러한 계층 구조를 통해 역할과 책임이 분리되어 유지보수성과 확장성이 높아집니다.' || CHR(10) || CHR(10) ||
    '### 2. 단일 서버와 분산 서버 구조' || CHR(10) ||
    '백엔드 서버 구조는 일반적으로 단일 서버 또는 분산 서버 형태로 설계됩니다. 단일 서버는 설정과 유지 관리가 간단하지만, 트래픽 증가 시 확장에 한계가 있습니다. 반면, 분산 서버는 여러 대의 서버로 트래픽을 분산 처리하여 확장성과 안정성을 제공합니다.' || CHR(10) || CHR(10) ||
    '예를 들어, 웹 애플리케이션에서 로드 밸런서를 활용해 사용자 요청을 여러 서버에 분산시키면, 갑작스러운 트래픽 증가에도 안정적으로 대응할 수 있습니다.' || CHR(10) || CHR(10) ||
    '### 3. 확장성을 고려한 설계 원칙' || CHR(10) ||
    '확장성을 고려한 백엔드 설계를 위해 다음 원칙을 염두에 두세요:' || CHR(10) ||
    '- **수평 확장 (Horizontal Scaling)**: 서버를 추가하여 트래픽 처리 용량을 늘리는 방식입니다.' || CHR(10) ||
    '- **수직 확장 (Vertical Scaling)**: 기존 서버의 성능을 업그레이드하여 처리 능력을 향상하는 방식입니다.' || CHR(10) ||
    '- **데이터베이스 샤딩 (Sharding)**: 대규모 데이터를 처리하기 위해 데이터베이스를 분할하여 저장하는 방법입니다.' || CHR(10) ||
    '- **캐싱 (Caching)**: 자주 요청되는 데이터를 미리 저장하여 응답 속도를 높이는 기술입니다.' || CHR(10) || CHR(10) ||
    '이러한 원칙을 적용하면 시스템의 부하를 효과적으로 관리할 수 있습니다.' || CHR(10) || CHR(10) ||
    '### 4. 보안과 성능 최적화' || CHR(10) ||
    '서버 아키텍처 설계 시 보안과 성능도 중요한 요소입니다. HTTPS를 통해 데이터 전송을 암호화하고, 데이터베이스에 적절한 권한을 설정하여 보안을 강화하세요. 또한, CDN(Content Delivery Network)을 활용하면 정적 리소스 로드를 최적화할 수 있습니다.' || CHR(10) || CHR(10) ||
    '### 5. 클라우드 기반 서버 활용하기' || CHR(10) ||
    'AWS, Azure, GCP와 같은 클라우드 플랫폼은 확장성과 관리 편의성을 제공합니다. 클라우드 서비스를 통해 필요에 따라 서버를 자동으로 확장하거나 축소할 수 있는 스케일링 기능을 활용하세요.' || CHR(10) || CHR(10) ||
    '백엔드 개발에서 서버 구조를 이해하고 설계하는 능력은 개발자의 역량을 크게 높여줍니다. 이번 글에서 소개한 기초 개념과 설계 원칙을 바탕으로 효율적이고 확장성 있는 서버 아키텍처를 구축해보세요.', 
    '/images/mentor-board/it개발데이터02.jpg', 
    TO_DATE('2025-01-07 09:30:00', 'YYYY-MM-DD HH24:MI:SS'), 
    278, 
    1, 
    8
);
...
VALUES (
    mentor_board_no_SEQ.nextval, 
    '데이터 분석가가 되기 위한 첫 걸음', 
    '데이터 분석가는 현대 비즈니스 환경에서 가장 중요한 직업 중 하나로 떠오르고 있습니다. 데이터를 통해 문제를 해결하고 인사이트를 도출하는 이 직업은 높은 수요와 성장 가능성을 가지고 있습니다. 이번 글에서는 데이터 분석가가 되기 위해 알아야 할 기초 지식과 실질적인 첫 걸음을 소개합니다.' || CHR(10) || CHR(10) ||
    '### 1. 데이터 분석의 기초 이해하기' || CHR(10) ||
    '데이터 분석은 데이터를 수집하고 정리한 뒤, 패턴과 트렌드를 발견해 의사결정에 도움을 주는 과정입니다. 가장 기본적인 통계 지식부터 시작해 데이터를 시각화하는 방법까지 학습해야 합니다. Excel, SQL, Python 등 도구 사용법도 필수입니다.' || CHR(10) || CHR(10) ||
    '### 2. 통계와 데이터 이해의 중요성' || CHR(10) ||
    '통계는 데이터 분석의 언어와도 같습니다. 평균, 분산, 상관관계와 같은 기초 통계 개념을 이해하고 활용할 줄 알아야 합니다. 이러한 기초 지식은 데이터를 해석하고, 문제를 정의하며, 적절한 분석 기법을 선택하는 데 필수적입니다.' || CHR(10) || CHR(10) ||
    '### 3. 사례를 통해 배우기' || CHR(10) ||
    '데이터 분석 공부는 이론보다 실전 사례를 통해 더 효과적으로 이뤄질 수 있습니다. 예를 들어, 고객 이탈률을 줄이기 위한 분석이나 매출 데이터를 기반으로 한 마케팅 캠페인 효과 측정과 같은 사례를 공부하며 실력을 키워보세요. Kaggle과 같은 플랫폼에서 제공하는 데이터셋으로 연습하는 것도 좋은 방법입니다.' || CHR(10) || CHR(10) ||
    '### 4. 머신러닝 기초 익히기' || CHR(10) ||
    '데이터 분석가는 머신러닝의 기초를 이해하는 것이 중요합니다. 지도 학습과 비지도 학습의 차이를 알고, 간단한 알고리즘을 활용해 데이터를 분석하는 방법을 익혀보세요. Python 라이브러리인 Scikit-learn이나 TensorFlow를 활용하면 기본적인 머신러닝 모델을 쉽게 구현할 수 있습니다.' || CHR(10) || CHR(10) ||
    '### 5. 지속적인 학습과 프로젝트 경험' || CHR(10) ||
    '데이터 분석가는 끊임없이 변화하는 기술과 도구를 따라가야 합니다. 최신 트렌드를 배우고 프로젝트 경험을 통해 실제 데이터 문제를 해결하는 능력을 키우세요. 포트폴리오를 준비하면서 자신의 능력을 효과적으로 보여줄 수 있는 프로젝트를 완성해 보세요.' || CHR(10) || CHR(10) ||
    '데이터 분석가는 데이터에 숨겨진 이야기를 찾아내는 탐정과도 같은 역할을 합니다. 기본 지식을 익히고, 사례를 통해 배우며, 프로젝트 경험을 쌓아 데이터 분석가로서의 여정을 시작해 보세요!', 
    '/images/mentor-board/it개발데이터06.jpg', 
    TO_DATE('2024-12-22 16:45:00', 'YYYY-MM-DD HH24:MI:SS'), 
    125, 
    1, 
    13
);
...
VALUES (
    mentor_board_no_SEQ.nextval, 
    '고등학생 학습법과 대학입시 준비', 
    '고등학교 시절은 학업과 진로를 동시에 준비해야 하는 중요한 시기입니다. 특히 대학 입시는 체계적인 계획과 전략이 필요한 도전입니다. 이번 글에서는 고등학생들이 학업 성취를 극대화하고 대학 입시에 성공하기 위해 실천할 수 있는 실질적인 가이드를 제공합니다.' || CHR(10) || CHR(10) ||
    '### 1. 시간 관리의 중요성' || CHR(10) ||
    '효율적인 시간 관리는 성공적인 학습의 시작입니다. 하루 일정을 시간 단위로 계획하고, 공부와 휴식을 균형 있게 배치하세요. 예를 들어, 주말에는 주요 과목 복습 시간을 늘리고, 평일에는 학교 과제를 철저히 정리하는 방식이 효과적입니다.' || CHR(10) || CHR(10) ||
    '### 2. 자신만의 공부법 찾기' || CHR(10) ||
    '모든 학생이 동일한 방식으로 공부할 필요는 없습니다. 자신에게 맞는 학습법을 찾아보세요. 시각적 학습을 선호한다면 플래시카드나 마인드맵을 활용하고, 청각적 학습을 선호한다면 녹음된 강의를 반복적으로 들어보세요.' || CHR(10) || CHR(10) ||
    '### 3. 대학 입시 정보를 적극적으로 탐색하기' || CHR(10) ||
    '대학 입시 성공을 위해서는 목표 대학과 전형 정보를 미리 파악하는 것이 중요합니다. 대학별 입시 요강, 모집 인원, 선호 과목 등을 분석해 자신에게 유리한 전략을 세워보세요. 학교 상담실이나 입시 관련 웹사이트를 적극 활용하세요.' || CHR(10) || CHR(10) ||
    '### 4. 모의고사와 실전 감각 키우기' || CHR(10) ||
    '모의고사는 실전 감각을 키우는 데 큰 도움이 됩니다. 시험 결과를 분석하여 약점을 파악하고, 취약 과목에 더 많은 시간을 투자하세요. 또한, 시험 환경과 유사한 조건에서 연습해 시험 스트레스를 줄이는 것도 중요합니다.' || CHR(10) || CHR(10) ||
    '### 5. 건강 관리와 휴식' || CHR(10) ||
    '학업 성취를 위해서는 건강한 몸이 필수입니다. 규칙적인 운동과 충분한 수면은 집중력을 높이는 데 도움을 줍니다. 또한, 스트레스 해소를 위해 취미 활동이나 친구들과의 대화 시간을 가지세요. 건강한 마음이 성공적인 학업을 뒷받침합니다.' || CHR(10) || CHR(10) ||
    '고등학교 시절은 힘든 시기일 수 있지만, 체계적인 준비와 꾸준한 노력이 뒷받침된다면 원하는 결과를 얻을 수 있습니다. 이 가이드를 참고해 목표를 향해 한 걸음씩 나아가 보세요.', 
    '/images/mentor-board/고등학생01.jpg', 
    TO_DATE('2024-12-03 22:12:00', 'YYYY-MM-DD HH24:MI:SS'), 
    434, 
    1, 
    35
);
...
VALUES (
    mentor_board_no_SEQ.nextval, 
    '예술적 영감을 얻는 방법', 
    '창작 과정에서 영감을 얻는 일은 모든 예술가에게 큰 도전이 될 수 있습니다. 때로는 아무리 노력해도 아이디어가 떠오르지 않을 때가 있죠. 하지만 영감은 우리가 조금만 시야를 넓히면 의외의 곳에서 쉽게 발견할 수 있습니다.' || CHR(10) || CHR(10) ||
    '첫 번째로, 자연 속에서 시간을 보내는 것을 추천합니다. 숲 속을 걷거나 바다를 바라보는 것만으로도 복잡한 생각들이 정리되고 마음이 평화로워지며 새로운 시각을 얻을 수 있습니다. 예를 들어, 모네와 같은 화가들은 자연의 빛과 색채에서 독특한 영감을 얻어 걸작들을 탄생시켰습니다.' || CHR(10) || CHR(10) ||
    '두 번째로, 다른 예술가들의 작품을 감상하는 것도 훌륭한 방법입니다. 미술관을 방문하거나, 음악 공연을 감상하며 자신과 다른 관점과 스타일을 경험해 보세요. 이는 새로운 아이디어와 표현 기법을 배우는 계기가 됩니다.' || CHR(10) || CHR(10) ||
    '세 번째로, 일상적인 사물을 새로운 시각으로 보는 연습을 해보세요. 단순한 컵이나 그림자 속에서도 독창적인 아이디어를 얻을 수 있습니다. 이는 사진 촬영이나 디자인 작업에서 특히 유용합니다.' || CHR(10) || CHR(10) ||
    '마지막으로, 일상에서 얻은 경험과 감정을 기록으로 남기는 습관을 들여보세요. 글로 쓰거나 그림으로 표현하며 창작의 원천으로 삼을 수 있습니다. 이런 작은 습관들이 모여 큰 영감으로 이어질 수 있습니다.' || CHR(10) || CHR(10) ||
    '영감은 노력과 습관 속에서 찾아옵니다. 무엇보다 중요한 것은 끊임없이 시도하고 배우며 자신의 창작 과정을 즐기는 것입니다. 언젠가 당신도 창작의 즐거움을 만끽할 수 있을 것입니다.', 
    '/images/mentor-board/미술04.jpg', 
    TO_DATE('2024-12-26 10:30:00', 'YYYY-MM-DD HH24:MI:SS'), 
    168, 
    1, 
    17
);
...
VALUES (
    mentor_board_no_SEQ.nextval, 
    '색채학의 기초와 활용', 
    '색채는 시각적인 예술뿐만 아니라 일상생활에서도 우리의 감정과 행동에 큰 영향을 미칩니다. 색채학을 이해하면 더 효과적으로 색을 사용할 수 있을 뿐만 아니라, 디자인, 예술, 마케팅 등 다양한 분야에서 창의력을 발휘할 수 있습니다. 이번 글에서는 색채학의 기초 이론과 실전 활용법을 알아보겠습니다.' || CHR(10) || CHR(10) ||
    '### 1. 색채학의 기초 이론' || CHR(10) ||
    '색채학은 색의 본질과 색상 간의 관계를 연구하는 학문입니다. 가장 기본적인 개념으로는 색상(Hue), 채도(Saturation), 명도(Brightness)가 있습니다. 색상은 빨강, 파랑, 노랑 등 특정 색의 이름을 의미하며, 채도는 색의 순도를 나타냅니다. 명도는 색의 밝고 어두운 정도를 말합니다. 이 세 가지 요소를 이해하면 색의 조합과 활용에 대한 기초를 다질 수 있습니다.' || CHR(10) || CHR(10) ||
    '### 2. 색상 조화와 색채 심리' || CHR(10) ||
    '색상 조화(Color Harmony)는 서로 잘 어울리는 색의 조합을 찾는 과정입니다. 예를 들어, 보색(Complementary Color)은 서로 반대되는 색으로 강렬한 대비를 만들어내는 반면, 유사색(Analogous Color)은 서로 가까운 색으로 부드러운 조화를 이룹니다. 이러한 조화 원칙을 활용하면 디자인과 예술에서 더 효과적인 색 선택이 가능합니다.' || CHR(10) || CHR(10) ||
    '또한, 색채는 심리적인 영향을 미칩니다. 빨강은 열정과 에너지를, 파랑은 안정과 평화를, 초록은 자연과 균형을 연상시킵니다. 이러한 색채 심리를 활용하면 원하는 감정을 유도하거나 메시지를 효과적으로 전달할 수 있습니다.' || CHR(10) || CHR(10) ||
    '### 3. 실전 색채 활용법' || CHR(10) ||
    '실제로 색을 활용할 때는 색상 팔레트를 만들어보는 것이 유용합니다. 디지털 도구나 페인트 칩을 사용하여 서로 어울리는 색상을 조합해보세요. 또한, 명도와 채도를 조정하며 같은 색이라도 다양한 변화를 시도해볼 수 있습니다.' || CHR(10) || CHR(10) ||
    '예를 들어, 인테리어 디자인에서 공간을 넓어 보이게 하고 싶다면 밝은 색상을 선택하고, 강렬한 포인트를 주고 싶다면 보색을 활용할 수 있습니다. 패션에서도 비슷한 원리를 적용할 수 있으며, 적절한 색 조합은 스타일을 돋보이게 만듭니다.' || CHR(10) || CHR(10) ||
    '### 4. 색채학을 통한 창의성 확장' || CHR(10) ||
    '색채학은 단순한 이론에 그치지 않고 우리의 창의력을 확장시키는 강력한 도구입니다. 실험적으로 색을 섞어보고 예상치 못한 조화를 발견하면서 자신만의 색감을 개발해보세요. 이 과정에서 실패를 두려워하지 말고 다양한 색상을 탐구해보는 것이 중요합니다.' || CHR(10) || CHR(10) ||
    '색채학을 이해하고 실전에서 활용하면 색을 다루는 능력이 향상될 뿐만 아니라, 더 나아가 예술과 디자인의 질을 높일 수 있습니다. 기초부터 실전까지 차근차근 학습하며, 자신만의 독창적인 색채 감각을 키워보세요.', 
    '/images/mentor-board/미술05.jpg', 
    TO_DATE('2024-12-25 16:15:00', 'YYYY-MM-DD HH24:MI:SS'), 
    175, 
    1, 
    17
);
...
VALUES (
    mentor_board_no_SEQ.nextval, 
    '조형 예술에서의 균형과 조화', 
    '조형 예술은 우리의 시각적 경험을 풍요롭게 만드는 중요한 예술 형태 중 하나입니다. 이러한 작품을 제작할 때, 균형과 조화는 필수적으로 고려해야 할 중요한 요소입니다.' || CHR(10) || CHR(10) ||
    '먼저, 균형이란 작품의 시각적 요소가 안정감을 주도록 배열되는 것을 의미합니다. 대칭적인 균형은 고전적이고 정제된 느낌을 주는 반면, 비대칭적인 균형은 역동적이고 창의적인 느낌을 제공합니다. 예를 들어, 르네상스 시대의 작품은 대칭적 균형의 훌륭한 예이며, 현대 추상미술에서는 비대칭적 균형이 자주 사용됩니다.' || CHR(10) || CHR(10) ||
    '다음으로, 조화는 작품의 모든 구성 요소가 서로 잘 어우러져 하나의 통일된 이미지를 만드는 것을 말합니다. 색상, 질감, 선의 흐름 등은 조화를 이루는 데 중요한 역할을 합니다. 조화로운 작품은 관람자에게 편안함과 만족감을 줄 수 있습니다. 반면, 조화가 부족하면 작품이 혼란스럽거나 어수선하게 느껴질 수 있습니다.' || CHR(10) || CHR(10) ||
    '작품 제작 시, 균형과 조화를 고려하기 위해 몇 가지 실전적인 방법을 사용할 수 있습니다. 예를 들어, 색상 조합을 미리 계획하거나, 스케치를 통해 시각적 요소의 배치를 실험해보는 것이 유용합니다. 또한, 다양한 각도에서 작품을 관찰하면서 요소 간의 관계를 조정하는 것도 중요합니다.' || CHR(10) || CHR(10) ||
    '결론적으로, 조형 예술에서의 균형과 조화는 단순히 기술적인 요소를 넘어, 작품의 감정적, 심미적 효과를 결정짓는 핵심적인 개념입니다. 이를 잘 이해하고 적용한다면 더욱 완성도 높은 작품을 만들 수 있을 것입니다.', 
    '/images/mentor-board/미술06.jpg', 
    TO_DATE('2024-12-30 18:00:00', 'YYYY-MM-DD HH24:MI:SS'), 
    150, 
    1, 
    17
);
...
VALUES (
    mentor_board_no_SEQ.nextval, 
    '연극 대본 분석과 캐릭터 이해하기', 
    '연극에서 좋은 연기를 위해서는 대본 분석과 캐릭터 이해가 무엇보다 중요합니다. 단순히 대사를 외우는 것을 넘어, 대본 속에서 캐릭터의 심리와 동기를 파악해야 비로소 살아 있는 연기를 할 수 있습니다. 이번 글에서는 대본 분석과 캐릭터를 깊이 이해하는 방법을 단계별로 소개합니다.' || CHR(10) || CHR(10) ||
    '### 1. 대본의 전체적인 맥락 파악하기' || CHR(10) ||
    '먼저 대본 전체를 처음부터 끝까지 읽으면서 이야기의 흐름과 주요 사건을 파악하세요. 이 단계에서는 세부적인 요소보다는 이야기의 큰 그림에 집중하는 것이 중요합니다. 예를 들어, 이 작품이 어떤 시대와 배경을 다루고 있는지, 주요 갈등은 무엇인지 등을 이해해야 합니다.' || CHR(10) || CHR(10) ||
    '### 2. 캐릭터의 목표와 동기 이해하기' || CHR(10) ||
    '대본을 통해 자신이 맡은 캐릭터의 목표와 동기를 분석하세요. 캐릭터가 왜 특정 행동을 하고, 어떤 감정을 느끼는지 이해하는 것이 중요합니다. 예를 들어, 캐릭터가 어떤 사건에 반응하는 방식은 그들의 과거 경험이나 가치관과 깊이 연결되어 있을 수 있습니다. 이를 통해 더 입체적인 연기를 만들어낼 수 있습니다.' || CHR(10) || CHR(10) ||
    '### 3. 대사 속 숨겨진 의미 찾기' || CHR(10) ||
    '대사는 단순한 문장이 아니라 캐릭터의 감정과 의도가 담긴 도구입니다. 대사를 말할 때 캐릭터가 실제로 무엇을 느끼고, 상대방에게 어떤 메시지를 전달하려고 하는지 파악하세요. 예를 들어, "괜찮아"라는 말이 진짜 괜찮다는 의미인지, 아니면 반대로 숨겨진 감정을 감추기 위한 것인지 분석해야 합니다.' || CHR(10) || CHR(10) ||
    '### 4. 캐릭터와 자신의 연결점 찾기' || CHR(10) ||
    '캐릭터를 더 깊이 이해하기 위해 자신과 캐릭터 사이의 공통점을 찾아보세요. 캐릭터가 경험한 상황과 비슷한 경험이 있다면, 그 감정을 되살려 연기에 활용할 수 있습니다. 자신이 캐릭터와 다르다고 느낀다면, 그 차이를 이해하고 상상력을 발휘해보는 것도 좋은 연습 방법입니다.' || CHR(10) || CHR(10) ||
    '### 5. 장면별 감정 변화 분석하기' || CHR(10) ||
    '대본 속에서 캐릭터가 어떤 감정 변화를 겪는지 장면별로 분석해보세요. 이 과정은 캐릭터의 내면을 이해하는 데 큰 도움이 됩니다. 예를 들어, 처음에는 긴장감을 느끼다가, 중간에 안도감을 찾고, 마지막에는 분노를 폭발시키는 식의 감정 흐름을 분석하면 자연스러운 연기를 만들어낼 수 있습니다.' || CHR(10) || CHR(10) ||
    '### 6. 동료와의 협력으로 캐릭터 완성하기' || CHR(10) ||
    '연극은 개인의 연기뿐만 아니라 다른 배우와의 호흡이 중요한 예술입니다. 대본 분석과 캐릭터 연구 후, 동료 배우들과의 리허설을 통해 캐릭터의 관계를 더 깊이 이해할 수 있습니다. 특히 서로의 캐릭터 간 갈등이나 협력의 요소를 탐구하면서 더욱 입체적인 장면을 만들 수 있습니다.' || CHR(10) || CHR(10) ||
    '대본 분석과 캐릭터 이해는 단순히 연기의 시작 단계가 아니라, 최고의 연기를 위한 필수 과정입니다. 위의 방법들을 활용하여 더 깊이 있는 연기를 만들어 보세요. 대본 속에 숨겨진 모든 의미를 발견하고, 캐릭터를 완전히 자신의 것으로 만드는 순간, 관객에게 강렬한 인상을 남길 수 있을 것입니다.', 
    '/images/mentor-board/연기연극04.jpg', 
    TO_DATE('2024-12-25 16:00:00', 'YYYY-MM-DD HH24:MI:SS'), 
    190, 
    1, 
    24
);
...
VALUES (
    mentor_board_no_SEQ.nextval, 
    '감정 표현의 다양성 연습법', 
    '감정은 인간의 삶에서 매우 중요한 요소이며, 이를 효과적으로 표현하는 것은 예술, 연기, 또는 일상적인 대화에서도 중요한 역할을 합니다. 하지만 많은 사람들은 감정을 표현하는 데 어려움을 느끼곤 합니다. 이번 글에서는 다양한 감정을 자연스럽게 표현할 수 있도록 도와주는 실전 연습법과 팁을 공유합니다.' || CHR(10) || CHR(10) ||
    '### 1. 감정 표현의 중요성 이해하기' || CHR(10) ||
    '감정을 표현하는 것은 단순히 감정을 전달하는 것뿐만 아니라 상대방과의 공감과 소통을 깊게 만드는 데 필수적입니다. 예를 들어, 연극이나 영화에서 배우가 자신의 감정을 자연스럽게 전달하면 관객은 그 감정에 몰입하게 됩니다. 이는 개인의 일상 대화에서도 마찬가지입니다.' || CHR(10) || CHR(10) ||
    '### 2. 다양한 감정을 탐구하기' || CHR(10) ||
    '다양한 감정을 탐구하는 것은 감정 표현의 첫걸음입니다. 기쁨, 슬픔, 분노, 두려움 등 기본적인 감정을 느껴보는 것부터 시작하세요. 과거의 경험을 떠올리며 각 감정이 당신에게 어떤 느낌을 주는지 기록하는 것도 좋은 방법입니다. 예를 들어, 특정 상황에서 느꼈던 감정을 메모에 적어보는 습관을 들여보세요.' || CHR(10) || CHR(10) ||
    '### 3. 감정을 몸으로 표현해보기' || CHR(10) ||
    '감정은 단순히 말로만 전달되는 것이 아닙니다. 몸의 움직임과 표정을 통해 표현하면 훨씬 더 강력한 전달력을 가질 수 있습니다. 거울 앞에서 다양한 표정을 연습해보거나, 감정에 따라 몸을 어떻게 움직일지 실험해보세요. 예를 들어, 슬픔을 표현할 때 어깨를 축 늘어뜨리거나, 분노를 표현할 때 주먹을 꽉 쥐는 방식으로 연습할 수 있습니다.' || CHR(10) || CHR(10) ||
    '### 4. 소리와 목소리로 감정 전달하기' || CHR(10) ||
    '목소리는 감정을 전달하는 데 매우 중요한 요소입니다. 같은 말을 하더라도 톤과 강약에 따라 완전히 다른 느낌을 줄 수 있습니다. 예를 들어, "나는 괜찮아"라는 말을 차분하게 말할 때와 분노 섞인 목소리로 말할 때 상대방이 느끼는 반응은 크게 달라질 것입니다. 감정을 담아 말하는 연습을 통해 감정 표현력을 향상시킬 수 있습니다.' || CHR(10) || CHR(10) ||
    '### 5. 롤플레이와 즉흥 연기로 연습하기' || CHR(10) ||
    '롤플레이와 즉흥 연기는 감정 표현 연습에 탁월한 방법입니다. 다른 사람과 함께 특정 상황을 설정하고 그 안에서 감정을 표현해보세요. 예를 들어, 기쁜 소식을 들었을 때의 반응이나 예상치 못한 슬픈 소식을 접했을 때의 감정을 연기하며 연습할 수 있습니다. 이는 특히 연기나 연극을 공부하는 사람들에게 매우 유용합니다.' || CHR(10) || CHR(10) ||
    '### 6. 감정 표현의 한계를 깨기' || CHR(10) ||
    '감정 표현은 연습을 통해 점점 더 자연스러워질 수 있습니다. 하지만 초기에 어색하거나 부자연스럽게 느껴지는 것은 지극히 정상입니다. 중요한 것은 자신만의 감정을 솔직하게 표현하려는 노력을 멈추지 않는 것입니다. 연습을 거듭하면서 새로운 감정을 발견하고 표현하는 데 익숙해질 것입니다.' || CHR(10) || CHR(10) ||
    '감정 표현은 단순한 기술이 아니라 자신을 이해하고 다른 사람과 연결될 수 있는 강력한 도구입니다. 이 글에서 소개한 방법들을 꾸준히 실천해보세요. 감정 표현력이 향상되면, 그것은 곧 예술적 표현뿐만 아니라 개인적인 성장에도 큰 도움이 될 것입니다.', 
    '/images/mentor-board/연기연극06.jpg', 
    TO_DATE('2024-12-28 18:15:00', 'YYYY-MM-DD HH24:MI:SS'), 
    225, 
    1, 
    24
);
...
VALUES (
    mentor_board_no_SEQ.nextval, 
    '스타트업 A to Z', 
    '스타트업은 꿈과 열정을 가진 사람들이 도전하는 영역으로, 고수익과 고성장의 가능성 때문에 많은 이들에게 매력적으로 다가옵니다. 하지만 스타트업의 현실은 생각보다 훨씬 더 가혹하며, 야생에 비유될 만큼 치열한 환경 속에서 생존 전략이 필수적입니다. 이번 글에서는 스타트업의 시작부터 성장, 그리고 생존까지의 여정을 단계별로 살펴보겠습니다.' || CHR(10) || CHR(10) ||
    '### 1. 아이디어 발굴과 비즈니스 모델 설계' || CHR(10) ||
    '스타트업의 첫걸음은 좋은 아이디어에서 시작됩니다. 하지만 아이디어만으로는 성공하기 어렵습니다. 아이디어가 해결하려는 문제가 무엇인지 명확히 정의하고, 이를 해결할 수 있는 실현 가능한 비즈니스 모델을 설계해야 합니다. 비즈니스 모델 캔버스(Business Model Canvas)를 활용하면 시장과 고객, 자원 및 수익 구조를 체계적으로 정리할 수 있습니다.' || CHR(10) || CHR(10) ||
    '### 2. 팀 구성의 중요성' || CHR(10) ||
    '스타트업 성공의 핵심 요소 중 하나는 뛰어난 팀을 구성하는 것입니다. 창업자는 자신의 비전을 공유할 수 있는 팀원을 모으고, 각자의 강점을 활용해 시너지를 만들어야 합니다. 특히 기술, 마케팅, 재무 등 다양한 분야의 전문성을 가진 팀원들이 필요합니다. 팀워크와 신뢰는 스타트업 생존에 필수적인 요소입니다.' || CHR(10) || CHR(10) ||
    '### 3. 자금 조달과 투자 유치' || CHR(10) ||
    '스타트업은 자금을 조달하는 능력이 매우 중요합니다. 초기 단계에서는 개인 자금이나 엔젤 투자, 크라우드 펀딩을 활용할 수 있습니다. 성장 단계에서는 벤처 캐피털(VC)이나 전략적 투자자를 유치해야 할 수 있습니다. 투자자들에게 매력적인 사업계획서를 준비하고, 성공적인 피칭을 통해 투자 유치를 이끌어내는 것이 중요합니다.' || CHR(10) || CHR(10) ||
    '### 4. 시장 진입 전략과 제품 출시' || CHR(10) ||
    '스타트업은 제품이나 서비스를 시장에 출시하는 시점이 매우 중요합니다. 초기 사용자 피드백을 수집하기 위해 최소 기능 제품(MVP, Minimum Viable Product)을 빠르게 출시하고, 이를 기반으로 개선해 나가는 것이 효과적입니다. 시장의 반응을 지속적으로 분석하고, 경쟁 상황에 맞춰 전략을 수정하는 유연성도 필요합니다.' || CHR(10) || CHR(10) ||
    '### 5. 생존 전략: 실패에서 배우기' || CHR(10) ||
    '스타트업 환경에서는 실패가 빈번하게 발생할 수 있습니다. 중요한 것은 실패에서 배우고, 이를 통해 더욱 견고한 전략을 세우는 것입니다. 자금 부족, 시장의 외면, 내부 갈등 등 여러 어려움을 겪을 수 있지만, 이를 극복하기 위해서는 끊임없는 학습과 적응력이 필요합니다.' || CHR(10) || CHR(10) ||
    '스타트업은 꿈을 현실로 만들기 위한 도전이며, 동시에 많은 어려움과 리스크를 동반합니다. 하지만 명확한 목표와 탄탄한 준비, 그리고 끊임없는 노력과 열정이 있다면 성공에 한 걸음 더 가까워질 수 있습니다. 스타트업의 야생에서 살아남기 위해 위에서 소개한 전략을 참고해 보세요.', 
    '/images/mentor-board/스타트업01.jpg', 
    TO_DATE('2024-12-11 15:31:01', 'YYYY-MM-DD HH24:MI:SS'), 
    472, 
    1, 
    15
);
...
VALUES (
    mentor_board_no_SEQ.nextval, 
    '스타트업을 위한 고객 개발 방법론', 
    '스타트업의 성공은 고객을 얼마나 잘 이해하고, 그들의 문제를 해결할 수 있는지에 달려 있습니다. 이번 글에서는 고객 개발 방법론을 활용해 고객의 요구를 파악하고, 시장에서 성공적으로 자리 잡는 방법을 소개합니다.' || CHR(10) || CHR(10) ||
    '### 1. 고객 개발이 중요한 이유' || CHR(10) ||
    '스타트업은 한정된 자원과 빠르게 변화하는 환경 속에서 효율적으로 운영되어야 합니다. 고객 개발은 고객의 니즈를 정확히 이해하고, 불필요한 자원을 낭비하지 않도록 도와줍니다. 이는 실패를 줄이고, 성공 확률을 높이는 핵심 전략입니다.' || CHR(10) || CHR(10) ||
    '### 2. 고객 인터뷰로 요구 파악하기' || CHR(10) ||
    '고객 개발의 첫 단계는 고객과 대화하는 것입니다. 인터뷰를 통해 고객이 겪고 있는 문제와 불편함을 직접 들어보세요. 이 과정에서 예상하지 못한 통찰을 얻을 수 있으며, 제품 개발 방향을 정하는 데 큰 도움이 됩니다.' || CHR(10) || CHR(10) ||
    '### 3. 실험과 피드백을 반복하라' || CHR(10) ||
    '고객 개발은 단순한 조사로 끝나지 않습니다. MVP(Minimum Viable Product)를 빠르게 만들어 고객의 반응을 확인하고, 피드백을 기반으로 개선점을 찾아야 합니다. 이러한 반복적인 과정이 제품의 완성도를 높이고, 고객 만족도를 극대화합니다.' || CHR(10) || CHR(10) ||
    '### 4. 데이터 기반 의사결정' || CHR(10) ||
    '고객 개발 과정에서 얻은 데이터를 분석하고, 이를 의사결정의 근거로 삼으세요. 감이 아닌 데이터로 움직이는 스타트업이 시장에서 더 오래 살아남습니다. 데이터를 통해 고객의 행동 패턴과 니즈를 정확히 이해할 수 있습니다.' || CHR(10) || CHR(10) ||
    '고객 개발은 단순히 고객을 이해하는 것을 넘어, 스타트업이 시장에서 생존하고 성장하는 데 필요한 핵심 역량입니다. 이번 글에서 소개한 방법론을 적용해 고객 중심의 스타트업으로 성장해 보세요.', 
    '/images/mentor-board/스타트업04.jpg', 
    TO_DATE('2024-08-10 09:45:00', 'YYYY-MM-DD HH24:MI:SS'), 
    350, 
    1, 
    15
);
...
VALUES (
    mentor_board_no_SEQ.nextval, 
    '스타트업 성장의 핵심 - 데이터 기반 의사결정', 
    '스타트업은 한정된 자원과 빠르게 변화하는 시장 환경 속에서 생존하고 성장해야 하는 도전적인 여정을 겪습니다. 이러한 환경에서 데이터를 기반으로 한 의사결정은 성공적인 비즈니스 운영의 핵심 요소로 떠오르고 있습니다. 이번 글에서는 데이터 기반 의사결정의 중요성과 이를 활용한 스타트업 성장 전략을 단계별로 소개합니다.' || CHR(10) || CHR(10) ||
    '### 1. 데이터 기반 의사결정의 중요성' || CHR(10) ||
    '데이터는 단순한 숫자의 집합이 아니라, 비즈니스 인사이트를 도출하는 강력한 도구입니다. 데이터를 분석하면 고객 행동, 시장 동향, 경쟁사의 전략 등을 파악할 수 있습니다. 이를 통해 감에 의존하는 의사결정에서 벗어나, 객관적이고 신뢰할 수 있는 근거를 바탕으로 효율적인 결정을 내릴 수 있습니다.' || CHR(10) || CHR(10) ||
    '### 2. 데이터 수집의 기본 원칙' || CHR(10) ||
    '데이터 기반 의사결정을 위해서는 적절한 데이터를 수집하는 것이 필수적입니다. 다음은 데이터 수집 시 고려해야 할 기본 원칙입니다:' || CHR(10) ||
    '- **관련성 (Relevance)**: 비즈니스 목표와 직접적으로 연관된 데이터를 수집해야 합니다.' || CHR(10) ||
    '- **정확성 (Accuracy)**: 데이터는 신뢰할 수 있고 정확해야 합니다.' || CHR(10) ||
    '- **적시성 (Timeliness)**: 최신 데이터를 수집하여 현재 상황을 반영해야 합니다.' || CHR(10) ||
    '고객 행동 데이터를 분석하거나 시장 동향을 파악하기 위해 Google Analytics, Mixpanel, Hotjar와 같은 도구를 활용할 수 있습니다.' || CHR(10) || CHR(10) ||
    '### 3. 데이터를 활용한 비즈니스 전략 수립' || CHR(10) ||
    '데이터를 분석하여 얻은 인사이트는 다양한 비즈니스 전략에 활용될 수 있습니다. 예를 들어:' || CHR(10) ||
    '- **고객 세분화**: 데이터를 기반으로 고객을 분류하고, 각 그룹에 맞춘 마케팅 캠페인을 실행합니다.' || CHR(10) ||
    '- **제품 개선**: 사용자의 행동 데이터를 분석해 제품의 강점과 약점을 파악하고, 이를 바탕으로 개선점을 도출합니다.' || CHR(10) ||
    '- **효율적인 자원 배분**: 데이터를 통해 비효율적인 프로세스를 발견하고 자원을 최적화합니다.' || CHR(10) || CHR(10) ||
    '### 4. 데이터 시각화와 커뮤니케이션' || CHR(10) ||
    '데이터 분석 결과를 효과적으로 전달하기 위해 데이터 시각화는 매우 중요한 도구입니다. Tableau, Power BI, Google Data Studio와 같은 도구를 사용하여 복잡한 데이터를 직관적으로 표현할 수 있습니다. 이는 팀원과 투자자들에게 데이터를 기반으로 한 설득력 있는 이야기를 전달하는 데 큰 도움이 됩니다.' || CHR(10) || CHR(10) ||
    '### 5. 지속적인 데이터 모니터링과 최적화' || CHR(10) ||
    '데이터 기반 의사결정은 일회성이 아니라 지속적인 과정입니다. 시장 환경과 고객 행동은 끊임없이 변화하므로, 데이터를 정기적으로 모니터링하고 전략을 최적화해야 합니다. 이를 위해 데이터 대시보드를 구축하거나 자동화된 리포팅 시스템을 활용해 실시간으로 데이터를 추적하세요.' || CHR(10) || CHR(10) ||
    '데이터 기반 의사결정은 스타트업의 성장을 가속화하는 강력한 도구입니다. 데이터 수집과 분석, 그리고 이를 활용한 전략 수립까지의 전 과정을 체계적으로 실행하면, 비즈니스 성과를 극대화할 수 있습니다. 데이터를 단순한 참고 자료로 보지 말고, 의사결정의 중심 도구로 활용해보세요.', 
    '/images/mentor-board/스타트업05.jpg', 
    TO_DATE('2024-10-18 16:00:00', 'YYYY-MM-DD HH24:MI:SS'), 
    400, 
    1, 
    15
);
...
VALUES (
    mentor_board_no_SEQ.nextval, 
    '운동 성과를 극대화하는 피트니스 팁', 
    '운동, 제대로 하면 성과가 두 배! 그냥 하면 땀만 나고, 제대로 하면 근육도 빵빵해진다는 거 아시죠? 이번 글에서는 운동 성과를 극대화하기 위한 꿀팁을 대방출합니다. 준비운동부터 루틴 설정까지, 헬린이도 헬스 고수로 거듭날 수 있는 방법들을 소개합니다.' || CHR(10) || CHR(10) ||
    '### 1. 준비운동으로 부상 예방하기' || CHR(10) ||
    '운동 시작 전에 "준비운동은 시간 낭비 아닌가?"라고 생각하셨다면, 그 생각 지금 당장 덤벨과 함께 내려놓으세요! 준비운동은 부상을 예방할 뿐 아니라 운동 성과를 높이는 데 필수입니다. 가벼운 스트레칭과 유산소 운동으로 몸을 풀어주면 근육이 더 잘 반응하게 됩니다.' || CHR(10) || CHR(10) ||
    '### 2. 운동 루틴은 균형 있게' || CHR(10) ||
    '하체는 미룬다고요? 상체만 빵빵하면 균형 잡힌 몸매는 꿈도 못 꿉니다. 상체, 하체, 코어 운동을 골고루 포함한 루틴을 짜보세요. 월요일은 가슴, 수요일은 등, 금요일은 하체! 이런 식으로 요일별로 나눠 루틴을 설정하면 더 체계적으로 운동할 수 있습니다.' || CHR(10) || CHR(10) ||
    '### 3. 적절한 중량과 횟수 선택' || CHR(10) ||
    '중량이 너무 가볍다면 효과가 적고, 너무 무거우면 부상의 위험이 높아집니다. 적절한 중량은 마지막 2~3회가 힘들게 느껴지는 정도가 적당합니다. "오 마이 갓! 못 하겠어!" 이 느낌이 들 때, 근육이 성장합니다.' || CHR(10) || CHR(10) ||
    '### 4. 휴식도 운동의 일부' || CHR(10) ||
    '운동만 열심히 하면 성과가 나올 거라구요? 아닙니다! 근육은 쉬는 동안 회복하며 성장합니다. 주 2회 이상의 휴식일을 설정하고, 매일 7~8시간의 숙면을 취하세요. "휴식도 운동이다"라는 말이 괜히 나온 게 아니랍니다.' || CHR(10) || CHR(10) ||
    '### 5. 영양 관리로 시너지 효과 내기' || CHR(10) ||
    '운동 후 단백질을 충분히 섭취해야 근육이 행복합니다. 닭가슴살, 두부, 달걀 등 단백질이 풍부한 음식을 챙겨 드세요. "운동만큼 중요한 건 식단이다"라는 말을 잊지 마세요. 운동 전 탄수화물 섭취도 에너지를 보충해주니 필수입니다.' || CHR(10) || CHR(10) ||
    '### 6. 운동 로그로 성과 추적하기' || CHR(10) ||
    '오늘 운동 몇 세트 했는지 기억 안 난다고요? 운동 노트를 써보세요. 어떤 운동을 몇 kg으로 몇 세트 했는지 기록하면, 점진적으로 강도를 올릴 때 유용합니다. 성과가 눈에 보이면 동기부여도 팍팍 됩니다!' || CHR(10) || CHR(10) ||
    '운동은 꾸준히 하는 것이 가장 중요합니다. 오늘 소개한 꿀팁들을 참고해 당신만의 루틴을 만들어 보세요. 꾸준히, 그리고 제대로 하면 어느새 목표에 도달해 있을 겁니다. "작심삼일"은 그만! 이제는 "작심삼십일, 삼백일, 삼천일"로 갑시다!', 
    '/images/mentor-board/피트니스01.jpg', 
    TO_DATE('2024-03-19 15:45:00', 'YYYY-MM-DD HH24:MI:SS'), 
    379, 
    1, 
    29
);
...
VALUES (
    mentor_board_no_SEQ.nextval, 
    '요가와 필라테스로 건강한 몸 만들기', 
    '현대인의 삶에서 건강을 유지하기 위해 운동은 필수적입니다. 특히 요가와 필라테스는 몸의 유연성을 높이고 자세를 교정하며, 정신적인 안정까지 제공하는 운동으로 많은 사랑을 받고 있습니다. 이번 글에서는 요가와 필라테스를 통해 건강한 몸을 만드는 방법을 간단히 소개합니다.' || CHR(10) || CHR(10) ||
    '### 1. 요가의 장점' || CHR(10) ||
    '요가는 스트레칭과 호흡법을 통해 몸의 유연성을 높이고, 마음의 평온을 찾게 도와줍니다. 특히 허리 통증이나 목 긴장 해소에 효과적입니다. 하루 15분만 투자해도 스트레스 해소와 몸의 균형을 개선할 수 있습니다.' || CHR(10) || CHR(10) ||
    '### 2. 필라테스의 효과' || CHR(10) ||
    '필라테스는 코어 근육 강화와 자세 교정을 돕는 운동입니다. 주로 반복적인 동작을 통해 체력을 길러주며, 앉아서 일하는 현대인들에게 특히 유용합니다. 올바른 자세로 운동하면 체형 개선에도 큰 도움을 줍니다.' || CHR(10) || CHR(10) ||
    '### 3. 간단한 요가와 필라테스 루틴' || CHR(10) ||
    '- 요가: 아침에 태양경배 자세로 하루를 시작해보세요. 간단하지만 전신의 유연성을 높이는 데 효과적입니다.' || CHR(10) ||
    '- 필라테스: 플랭크와 브릿지 동작을 10분씩 반복하며 코어 근육을 강화하세요. 짧은 시간에도 큰 효과를 볼 수 있습니다.' || CHR(10) || CHR(10) ||
    '요가와 필라테스는 특별한 장비 없이도 쉽게 시작할 수 있는 운동입니다. 이번 주부터 간단한 루틴을 실천하며 몸과 마음을 동시에 건강하게 만들어 보세요!', 
    '/images/mentor-board/요가필라테스01.jpg', 
    TO_DATE('2024-12-06 19:37:00', 'YYYY-MM-DD HH24:MI:SS'), 
    337, 
    1, 
    37
);
...
insert into chat_room (chat_room_no, chat_room_status, chat_room_start_date, chat_room_end_date, mentee_no, mentor_no)
values(chat_room_no_SEQ.nextval, 7100, sysdate, null, 4, 2);
insert into chat_room (chat_room_no, chat_room_status, chat_room_start_date, chat_room_end_date, mentee_no, mentor_no)
values(chat_room_no_SEQ.nextval, 7100, sysdate, null, 5, 2);

insert into chat_room (chat_room_no, chat_room_status, chat_room_start_date, chat_room_end_date, mentee_no, mentor_no)
values(chat_room_no_SEQ.nextval, 7100, sysdate, null, 2, 8);
insert into chat_room (chat_room_no, chat_room_status, chat_room_start_date, chat_room_end_date, mentee_no, mentor_no)
...
insert into chat_room (chat_room_no, chat_room_status, chat_room_start_date, chat_room_end_date, mentee_no, mentor_no)
values(chat_room_no_SEQ.nextval, 7000, sysdate, null, 2, 12);
insert into chat_room (chat_room_no, chat_room_status, chat_room_start_date, chat_room_end_date, mentee_no, mentor_no)
values(chat_room_no_SEQ.nextval, 7100, sysdate, null, 2, 13);
insert into chat_room (chat_room_no, chat_room_status, chat_room_start_date, chat_room_end_date, mentee_no, mentor_no)
values(chat_room_no_SEQ.nextval, 7100, sysdate, null, 2, 22);
insert into chat_room (chat_room_no, chat_room_status, chat_room_start_date, chat_room_end_date, mentee_no, mentor_no)
values(chat_room_no_SEQ.nextval, 7100, sysdate, null, 2, 5);
insert into chat_room (chat_room_no, chat_room_status, chat_room_start_date, chat_room_end_date, mentee_no, mentor_no)
values(chat_room_no_SEQ.nextval, 7100, sysdate, null, 12, 11);
insert into chat_room (chat_room_no, chat_room_status, chat_room_start_date, chat_room_end_date, mentee_no, mentor_no)
values(chat_room_no_SEQ.nextval, 7100, sysdate, null, 1, 11);
insert into chat_room (chat_room_no, chat_room_status, chat_room_start_date, chat_room_end_date, mentee_no, mentor_no)
values(chat_room_no_SEQ.nextval, 7100, sysdate, null, 2, 28);
insert into chat_room (chat_room_no, chat_room_status, chat_room_start_date, chat_room_end_date, mentee_no, mentor_no)
values(chat_room_no_SEQ.nextval, 7100, sysdate, null, 2, 17);
insert into chat_room (chat_room_no, chat_room_status, chat_room_start_date, chat_room_end_date, mentee_no, mentor_no)
values(chat_room_no_SEQ.nextval, 7100, sysdate, null, 6, 11);
insert into chat_room (chat_room_no, chat_room_status, chat_room_start_date, chat_room_end_date, mentee_no, mentor_no)
values(chat_room_no_SEQ.nextval, 7100, sysdate, null, 4, 28);
insert into chat_room (chat_room_no, chat_room_status, chat_room_start_date, chat_room_end_date, mentee_no, mentor_no)
values(chat_room_no_SEQ.nextval, 7100, sysdate, null, 44, 17);
insert into chat_room (chat_room_no, chat_room_status, chat_room_start_date, chat_room_end_date, mentee_no, mentor_no)
values(chat_room_no_SEQ.nextval, 7100, sysdate, null, 37, 11);
insert into chat_room (chat_room_no, chat_room_status, chat_room_start_date, chat_room_end_date, mentee_no, mentor_no)
values(chat_room_no_SEQ.nextval, 7100, sysdate, null, 21, 28);
insert into chat_room (chat_room_no, chat_room_status, chat_room_start_date, chat_room_end_date, mentee_no, mentor_no)
values(chat_room_no_SEQ.nextval, 7100, sysdate, null, 28, 17);
insert into chat_room (chat_room_no, chat_room_status, chat_room_start_date, chat_room_end_date, mentee_no, mentor_no)
values(chat_room_no_SEQ.nextval, 7100, sysdate, null, 32, 11);
insert into chat_room (chat_room_no, chat_room_status, chat_room_start_date, chat_room_end_date, mentee_no, mentor_no)
values(chat_room_no_SEQ.nextval, 7100, sysdate, null, 40, 28);
insert into chat_room (chat_room_no, chat_room_status, chat_room_start_date, chat_room_end_date, mentee_no, mentor_no)
values(chat_room_no_SEQ.nextval, 7100, sysdate, null, 12, 17);
insert into chat_room (chat_room_no, chat_room_status, chat_room_start_date, chat_room_end_date, mentee_no, mentor_no)
values(chat_room_no_SEQ.nextval, 7100, sysdate, null, 17, 11);
insert into chat_room (chat_room_no, chat_room_status, chat_room_start_date, chat_room_end_date, mentee_no, mentor_no)
values(chat_room_no_SEQ.nextval, 7100, sysdate, null, 11, 28);
insert into chat_room (chat_room_no, chat_room_status, chat_room_start_date, chat_room_end_date, mentee_no, mentor_no)
values(chat_room_no_SEQ.nextval, 7100, sysdate, null, 33, 17);
...
insert into chat_room_status (chat_room_no, chat_room_name, chat_room_status, member_no, chat_room_status_no) 
values (6, '이도현님과 이지현님의 채팅방', 7600, 2, chat_room_status_no_SEQ.nextval);
insert into chat_room_status (chat_room_no, chat_room_name, chat_room_status, member_no, chat_room_status_no) 
values (6, '이도현님과 이지현님의 채팅방', 7600, 10, chat_room_status_no_SEQ.nextval);
insert into chat_room_status (chat_room_no, chat_room_name, chat_room_status, member_no, chat_room_status_no) 
...
insert into chat_room_status (chat_room_no, chat_room_name, chat_room_status, member_no, chat_room_status_no) 
values (10, '이도현님과 김태윤님의 채팅방', 7600, 2, chat_room_status_no_SEQ.nextval);
insert into chat_room_status (chat_room_no, chat_room_name, chat_room_status, member_no, chat_room_status_no) 
values (10, '이도현님과 김태윤님의 채팅방', 7600, 22, chat_room_status_no_SEQ.nextval);
insert into chat_room_status (chat_room_no, chat_room_name, chat_room_status, member_no, chat_room_status_no) 
values (11, '이도현님과 나문정님의 채팅방', 7600, 2, chat_room_status_no_SEQ.nextval);
insert into chat_room_status (chat_room_no, chat_room_name, chat_room_status, member_no, chat_room_status_no) 
values (11, '이도현님과 나문정님의 채팅방', 7600, 5, chat_room_status_no_SEQ.nextval);

insert into chat_room_status (chat_room_no, chat_room_name, chat_room_status, member_no, chat_room_status_no) 
values (12, '이서준님과 김민수님의 채팅방', 7600, 12, chat_room_status_no_SEQ.nextval);
insert into chat_room_status (chat_room_no, chat_room_name, chat_room_status, member_no, chat_room_status_no) 
values (12, '이서준님과 김민수님의 채팅방', 7600, 11, chat_room_status_no_SEQ.nextval);

insert into chat_room_status (chat_room_no, chat_room_name, chat_room_status, member_no, chat_room_status_no) 
values (13, '이서준님과 김민수님의 채팅방', 7600, 1, chat_room_status_no_SEQ.nextval);
insert into chat_room_status (chat_room_no, chat_room_name, chat_room_status, member_no, chat_room_status_no) 
values (13, '이서준님과 김민수님의 채팅방', 7600, 11, chat_room_status_no_SEQ.nextval);

insert into chat_room_status (chat_room_no, chat_room_name, chat_room_status, member_no, chat_room_status_no) 
values (14, '이도현님과 최유진님의 채팅방', 7600, 2, chat_room_status_no_SEQ.nextval);
insert into chat_room_status (chat_room_no, chat_room_name, chat_room_status, member_no, chat_room_status_no) 
values (14, '이도현님과 최유진님의 채팅방', 7600, 28, chat_room_status_no_SEQ.nextval);

insert into chat_room_status (chat_room_no, chat_room_name, chat_room_status, member_no, chat_room_status_no) 
values (15, '이도현님과 김도윤님의 채팅방', 7600, 2, chat_room_status_no_SEQ.nextval);
insert into chat_room_status (chat_room_no, chat_room_name, chat_room_status, member_no, chat_room_status_no) 
values (15, '이도현님과 김도윤님의 채팅방', 7600, 17, chat_room_status_no_SEQ.nextval);

insert into chat_room_status (chat_room_no, chat_room_name, chat_room_status, member_no, chat_room_status_no) 
values (16, '문준형님과 김민수님의 채팅방', 7600, 6, chat_room_status_no_SEQ.nextval);
insert into chat_room_status (chat_room_no, chat_room_name, chat_room_status, member_no, chat_room_status_no) 
values (16, '문준형님과 김민수님의 채팅방', 7600, 11, chat_room_status_no_SEQ.nextval);

insert into chat_room_status (chat_room_no, chat_room_name, chat_room_status, member_no, chat_room_status_no) 
values (17, '김찬영님과 최유진님의 채팅방', 7600, 4, chat_room_status_no_SEQ.nextval);
insert into chat_room_status (chat_room_no, chat_room_name, chat_room_status, member_no, chat_room_status_no) 
values (17, '김찬영님과 최유진님의 채팅방', 7600, 28, chat_room_status_no_SEQ.nextval);

insert into chat_room_status (chat_room_no, chat_room_name, chat_room_status, member_no, chat_room_status_no) 
values (18, '한유진님과 김도윤님의 채팅방', 7600, 44, chat_room_status_no_SEQ.nextval);
insert into chat_room_status (chat_room_no, chat_room_name, chat_room_status, member_no, chat_room_status_no) 
values (18, '한유진님과 김도윤님의 채팅방', 7600, 17, chat_room_status_no_SEQ.nextval);

insert into chat_room_status (chat_room_no, chat_room_name, chat_room_status, member_no, chat_room_status_no) 
values (19, '이서윤님과 김민수님의 채팅방', 7600, 37, chat_room_status_no_SEQ.nextval);
insert into chat_room_status (chat_room_no, chat_room_name, chat_room_status, member_no, chat_room_status_no) 
values (19, '이서윤님과 김민수님의 채팅방', 7600, 11, chat_room_status_no_SEQ.nextval);

insert into chat_room_status (chat_room_no, chat_room_name, chat_room_status, member_no, chat_room_status_no) 
values (20, '김윤하님과 최유진님의 채팅방', 7600, 21, chat_room_status_no_SEQ.nextval);
insert into chat_room_status (chat_room_no, chat_room_name, chat_room_status, member_no, chat_room_status_no) 
values (20, '김윤하님과 최유진님의 채팅방', 7600, 28, chat_room_status_no_SEQ.nextval);

insert into chat_room_status (chat_room_no, chat_room_name, chat_room_status, member_no, chat_room_status_no) 
values (21, '최유진님과 김도윤님의 채팅방', 7600, 28, chat_room_status_no_SEQ.nextval);
insert into chat_room_status (chat_room_no, chat_room_name, chat_room_status, member_no, chat_room_status_no) 
values (21, '최유진님과 김도윤님의 채팅방', 7600, 17, chat_room_status_no_SEQ.nextval);

insert into chat_room_status (chat_room_no, chat_room_name, chat_room_status, member_no, chat_room_status_no) 
values (22, '박정민님과 김민수님의 채팅방', 7600, 32, chat_room_status_no_SEQ.nextval);
insert into chat_room_status (chat_room_no, chat_room_name, chat_room_status, member_no, chat_room_status_no) 
values (22, '박정민님과 김민수님의 채팅방', 7600, 11, chat_room_status_no_SEQ.nextval);

insert into chat_room_status (chat_room_no, chat_room_name, chat_room_status, member_no, chat_room_status_no) 
values (23, '이서준님과 김민수님의 채팅방', 7600, 40, chat_room_status_no_SEQ.nextval);
insert into chat_room_status (chat_room_no, chat_room_name, chat_room_status, member_no, chat_room_status_no) 
values (23, '이서준님과 김민수님의 채팅방', 7600, 28, chat_room_status_no_SEQ.nextval);

insert into chat_room_status (chat_room_no, chat_room_name, chat_room_status, member_no, chat_room_status_no) 
values (24, '정민호님과 김도윤님의 채팅방', 7600, 12, chat_room_status_no_SEQ.nextval);
insert into chat_room_status (chat_room_no, chat_room_name, chat_room_status, member_no, chat_room_status_no) 
values (24, '정민호님과 김도윤님의 채팅방', 7600, 17, chat_room_status_no_SEQ.nextval);

insert into chat_room_status (chat_room_no, chat_room_name, chat_room_status, member_no, chat_room_status_no) 
values (25, '김도윤님과 김민수님의 채팅방', 7600, 17, chat_room_status_no_SEQ.nextval);
insert into chat_room_status (chat_room_no, chat_room_name, chat_room_status, member_no, chat_room_status_no) 
values (25, '김도윤님과 김민수님의 채팅방', 7600, 11, chat_room_status_no_SEQ.nextval);

insert into chat_room_status (chat_room_no, chat_room_name, chat_room_status, member_no, chat_room_status_no) 
values (26, '김민수님과 김민수님의 채팅방', 7600, 11, chat_room_status_no_SEQ.nextval);
insert into chat_room_status (chat_room_no, chat_room_name, chat_room_status, member_no, chat_room_status_no) 
values (26, '김민수님과 김민수님의 채팅방', 7600, 28, chat_room_status_no_SEQ.nextval);

insert into chat_room_status (chat_room_no, chat_room_name, chat_room_status, member_no, chat_room_status_no) 
values (27, '이서준님과 김도윤님의 채팅방', 7600, 33, chat_room_status_no_SEQ.nextval);
insert into chat_room_status (chat_room_no, chat_room_name, chat_room_status, member_no, chat_room_status_no) 
values (27, '이서준님과 김도윤님의 채팅방', 7600, 17, chat_room_status_no_SEQ.nextval);
...
insert into review (review_no, review_title, review_status, review_content, review_score, review_date, chat_room_no)
values (review_no_SEQ.nextval, '좀 아쉬운 부분이 있었어요', 1, '멘토님은 좋은 분이시지만, 제가 기대한 내용과는 조금 달랐어요. 그래도 유익한 시간은 되었어요.', 3, sysdate, 2);
insert into review (review_no, review_title, review_status, review_content, review_score, review_date, chat_room_no)
values (review_no_SEQ.nextval, '좀 아쉬운 부분이 많았어요', 1, '멘토님은 좋은 분이시지만, 제가 기대한 내용과는 조금 달랐어요. 그래도 유익한 시간은 되었어요.', 3, sysdate, 3);

insert into review (review_no, review_title, review_status, review_content, review_score, review_date, chat_room_no)
values (review_no_SEQ.nextval, '완벽한 멘토링!', 1, '정말 최고였어요! 멘토님의 조언 덕분에 고민이 해결됐고, 실질적인 도움을 많이 받았습니다. 추천드려요!', 5, sysdate, 4);

insert into review (review_no, review_title, review_status, review_content, review_score, review_date, chat_room_no)
values (review_no_SEQ.nextval, '멘토님이 너무 친절했어요', 1, '멘토님이 너무 친절하고 잘 설명해 주셔서 편하게 질문할 수 있었습니다. 덕분에 많은 도움이 되었어요. 감사합니다!', 4, sysdate, 5);

insert into review (review_no, review_title, review_status, review_content, review_score, review_date, chat_room_no)
values (review_no_SEQ.nextval, '조금 아쉬웠어요', 1, '멘토님의 경험은 풍부하셨지만, 제 상황에 맞는 구체적인 예시를 더 들어주셨으면 좋았을 것 같아요.', 2, sysdate, 1);

insert into review (review_no, review_title, review_status, review_content, review_score, review_date, chat_room_no)
values (review_no_SEQ.nextval, '좋은 경험이었어요', 1, '멘토님의 조언이 정말 도움이 되었어요. 다만, 약간의 시간이 부족했던 점은 아쉬웠습니다.', 4, sysdate, 2);

insert into review (review_no, review_title, review_status, review_content, review_score, review_date, chat_room_no)
values (review_no_SEQ.nextval, '다시 만나고 싶은 멘토!', 1, '멘토님은 정말 따뜻하고 친절하세요. 어려운 질문도 잘 설명해 주셔서 큰 도움이 되었어요.', 5, sysdate, 10);

insert into review (review_no, review_title, review_status, review_content, review_score, review_date, chat_room_no)
values (review_no_SEQ.nextval, '기대보다 부족했던 멘토링', 1, '멘토님의 말씀이 유익하지 않아서 기대했던 만큼의 도움을 받지 못했습니다. 조금 아쉬워요.', 2, sysdate, 11);

insert into review (review_no, review_title, review_status, review_content, review_score, review_date, chat_room_no)
values (review_no_SEQ.nextval, '조금 더 구체적인 피드백을 원했어요', 1, '멘토님은 좋으셨지만, 제 상황에 대해 좀 더 구체적인 조언을 듣고 싶었어요. 전반적으로 괜찮은 경험이었습니다.', 3, sysdate, 12);

insert into review (review_no, review_title, review_status, review_content, review_score, review_date, chat_room_no)
values (review_no_SEQ.nextval, '매우 만족했습니다!', 1, '멘토님의 지도 덕분에 많은 것이 변했습니다. 제가 원하는 방향으로 도움을 주셔서 매우 만족했습니다. 감사해요!', 5, sysdate, 10);

insert into review (review_no, review_title, review_status, review_content, review_score, review_date, chat_room_no)
values (review_no_SEQ.nextval, '좋은 경험이었어요', 1, '멘토님이 친절하시고 세심하게 도와주셨습니다. 덕분에 많은 도움이 되었습니다.', 4, sysdate, 11);

insert into review (review_no, review_title, review_status, review_content, review_score, review_date, chat_room_no)
values (review_no_SEQ.nextval, '완벽한 멘토링!', 1, '정말 최고였어요! 멘토님의 조언 덕분에 고민이 해결됐고, 실질적인 도움을 많이 받았습니다. 추천드려요!', 5, sysdate, 12);


insert into review (review_no, review_title, review_status, review_content, review_score, review_date, chat_room_no)
values (review_no_SEQ.nextval, '도움이 많이 되었어요', 1, '멘토님 덕분에 여러 문제를 해결할 수 있었어요. 구체적인 피드백을 통해 많은 것을 배우게 되었습니다.', 5, sysdate, 10);
...
insert into review (review_no, review_title, review_status, review_content, review_score, review_date, chat_room_no)
values (review_no_SEQ.nextval, '좀 아쉬운 부분이 많았어요', 1, '멘토님은 좋은 분이시지만, 제가 기대한 내용과는 조금 달랐어요. 그래도 유익한 시간은 되었어요.', 3, sysdate, 13);

insert into review (review_no, review_title, review_status, review_content, review_score, review_date, chat_room_no)
values (review_no_SEQ.nextval, '완벽한 멘토링!', 1, '정말 최고였어요! 멘토님의 조언 덕분에 고민이 해결됐고, 실질적인 도움을 많이 받았습니다. 추천드려요!', 5, sysdate, 14);

insert into review (review_no, review_title, review_status, review_content, review_score, review_date, chat_room_no)
values (review_no_SEQ.nextval, '멘토님이 너무 친절했어요', 1, '멘토님이 너무 친절하고 잘 설명해 주셔서 편하게 질문할 수 있었습니다. 덕분에 많은 도움이 되었어요. 감사합니다!', 4, sysdate, 15);

insert into review (review_no, review_title, review_status, review_content, review_score, review_date, chat_room_no)
values (review_no_SEQ.nextval, '조금 아쉬웠어요', 1, '멘토님의 경험은 풍부하셨지만, 제 상황에 맞는 구체적인 예시를 더 들어주셨으면 좋았을 것 같아요.', 2, sysdate, 16);

insert into review (review_no, review_title, review_status, review_content, review_score, review_date, chat_room_no)
values (review_no_SEQ.nextval, '좋은 경험이었어요', 1, '멘토님의 조언이 정말 도움이 되었어요. 다만, 약간의 시간이 부족했던 점은 아쉬웠습니다.', 4, sysdate, 17);

insert into review (review_no, review_title, review_status, review_content, review_score, review_date, chat_room_no)
values (review_no_SEQ.nextval, '다시 만나고 싶은 멘토!', 1, '멘토님은 정말 따뜻하고 친절하세요. 어려운 질문도 잘 설명해 주셔서 큰 도움이 되었어요.', 5, sysdate, 18);

insert into review (review_no, review_title, review_status, review_content, review_score, review_date, chat_room_no)
values (review_no_SEQ.nextval, '기대보다 부족했던 멘토링', 1, '멘토님의 말씀이 유익하지 않아서 기대했던 만큼의 도움을 받지 못했습니다. 조금 아쉬워요.', 2, sysdate, 19);

insert into review (review_no, review_title, review_status, review_content, review_score, review_date, chat_room_no)
values (review_no_SEQ.nextval, '조금 더 구체적인 피드백을 원했어요', 1, '멘토님은 좋으셨지만, 제 상황에 대해 좀 더 구체적인 조언을 듣고 싶었어요. 전반적으로 괜찮은 경험이었습니다.', 3, sysdate, 20);

insert into review (review_no, review_title, review_status, review_content, review_score, review_date, chat_room_no)
values (review_no_SEQ.nextval, '매우 만족했습니다!', 1, '멘토님의 지도 덕분에 많은 것이 변했습니다. 제가 원하는 방향으로 도움을 주셔서 매우 만족했습니다. 감사해요!', 5, sysdate, 21);

insert into review (review_no, review_title, review_status, review_content, review_score, review_date, chat_room_no)
values (review_no_SEQ.nextval, '좋은 경험이었어요', 1, '멘토님이 친절하시고 세심하게 도와주셨습니다. 덕분에 많은 도움이 되었습니다.', 4, sysdate, 22);

insert into review (review_no, review_title, review_status, review_content, review_score, review_date, chat_room_no)
values (review_no_SEQ.nextval, '완벽한 멘토링!', 1, '정말 최고였어요! 멘토님의 조언 덕분에 고민이 해결됐고, 실질적인 도움을 많이 받았습니다. 추천드려요!', 5, sysdate, 23);

insert into review (review_no, review_title, review_status, review_content, review_score, review_date, chat_room_no)
values (review_no_SEQ.nextval, '조금 아쉬웠어요', 1, '멘토님의 경험은 풍부하셨지만, 제 상황에 맞는 구체적인 예시를 더 들어주셨으면 좋았을 것 같아요.', 2, sysdate, 24);

insert into review (review_no, review_title, review_status, review_content, review_score, review_date, chat_room_no)
values (review_no_SEQ.nextval, '좋은 경험이었어요', 1, '멘토님의 조언이 정말 도움이 되었어요. 다만, 약간의 시간이 부족했던 점은 아쉬웠습니다.', 4, sysdate, 25);

insert into review (review_no, review_title, review_status, review_content, review_score, review_date, chat_room_no)
values (review_no_SEQ.nextval, '다시 만나고 싶은 멘토!', 1, '멘토님은 정말 따뜻하고 친절하세요. 어려운 질문도 잘 설명해 주셔서 큰 도움이 되었어요.', 5, sysdate, 26);

insert into review (review_no, review_title, review_status, review_content, review_score, review_date, chat_room_no)
values (review_no_SEQ.nextval, '조금 더 구체적인 피드백을 원했어요', 1, '멘토님은 좋으셨지만, 제 상황에 대해 좀 더 구체적인 조언을 듣고 싶었어요. 전반적으로 괜찮은 경험이었습니다.', 3, sysdate, 27);
