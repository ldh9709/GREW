...
public class ChatMessageImageDto {
    ...
    private ChatMessageDto chatMessageNo; // chatMessage의 ID만 필요한 경우
    ...
    public static ChatMessageImageDto toDto(ChatMessageImage chatMessageImagedto) {
        return ChatMessageImageDto.builder()
                ...
                .chatMessageNo(ChatMessageDto.toDto(chatMessageImagedto.getChatMessageno())) // ChatMessage 객체를 직접 전달
                .build();
    }
}
